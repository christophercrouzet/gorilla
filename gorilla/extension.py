...
class Extension(object):
    ...
    def __init__(self, source, target):
        ...
        ----
            ...
            object to use as a patch from the ``__dict__`` attribute if
            you need to transfer all the decorators applied to it.
    ...
    def patch(self):
        ...
        if (original and (not gorilla._python.PY2 or
                          source_type != gorilla._objecttype.CLASS)):
